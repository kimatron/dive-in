...
class About(models.Model):
    ...
    hero_subtitle = models.TextField(
        help_text="A brief tagline or introduction",
        default="Discover the underwater world with our diving community",
        blank=True
    )
    ...
    vision = models.TextField(
        help_text="Our vision for the diving community",
        default="",
        blank=True
    )
    ...
    total_divers = models.PositiveIntegerField(
        default=0,
        help_text="Number of divers in our community"
    )
    dive_locations = models.PositiveIntegerField(
        default=0,
        help_text="Number of dive locations covered"
    )
